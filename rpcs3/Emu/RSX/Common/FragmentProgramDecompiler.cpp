...
bool FragmentProgramDecompiler::handle_tex_srb(u32 opcode)
{
	...
	case RSX_FP_OPCODE_TXP: SetDst("$t.Sample($tsampler, $0.xy / $0.z)"); return true; //TODO: More testing (Sonic The Hedgehog (NPUB-30442/NPEB-00478) and The Simpsons Arcade Game (NPUB30563))
